...
%TODO indexing from to is inversed!
dTdx_somega= (dy_S_P*T_s + dy_Sw_S*T_Somega + dy_w_Sw*T_sw + dy_P_w*T_omega)/S_somega;
dTdy_somega= -(dx_S_P*T_s + dx_Sw_S*T_Somega + dx_w_Sw*T_sw + dx_P_w*T_omega)/S_somega;

dTdx_nomega= 1/S_nomega*(dy_P_N*T_n + dy_N_Nw*T_Nomega + dy_Nw_w*T_nw + dy_w_P*T_omega);
dTdy_nomega= -1/S_nomega*(dx_P_N*T_n + dx_N_Nw*T_Nomega + dx_Nw_w*T_nw + dx_w_P*T_omega);
...
% Build hole stecil acounting for quadratic lambda like in Helmholtz 
  ...
  DDT = 1/S_omega*(dTdx_nomega*dy_n_nw - dTdy_nomega*dx_n_nw + dTdx_w*dy_nw_sw - dTdy_w*dx_nw_sw + dTdx_somega*dy_sw_s - dTdy_somega* dx_sw_s);
