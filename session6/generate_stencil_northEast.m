...
dTdx_sigmaw=  (dy_s_P*T_sigma + dy_sW_s*T_sw + dy_W_sW*T_sigmaW + dy_P_W*T_w)/S_sigmaw;
dTdy_sigmaw=  -(dx_s_P*T_sigma + dx_sW_s*T_sw + dx_W_sW*T_sigmaW + dx_P_W*T_w)/S_sigmaw;
